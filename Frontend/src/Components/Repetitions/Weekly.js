...
export default function Weekly( {item} ) {
    ...
    return (
        <List>
            <ListItem style={darkMode? textStyleDark: textStyle}>
                ...
                <ListItemText primary={'Do It Every ' + item['weekday'].charAt(0).toUpperCase() + item['weekday'].slice(1)} primaryTypographyProps={{ variant: 'caption' }} />
            </ListItem>
            <Divider />
            <ListItem style={darkMode? textStyleDark: textStyle}>
                <ListItemAvatar>
